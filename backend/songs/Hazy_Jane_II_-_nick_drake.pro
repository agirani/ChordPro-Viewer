{title: Hazy Jane II}
{subtitle: nick drake}
{c:To make the first verse more interesting, during the extended Am parts one can alternate between Am (x02210)}
{c:and A7sus2 (x02000), inserting the latter at the last upward strum of each measure }
{c:(i.e. a matter of lifting one's middle and index fingers for a brief moment).}
